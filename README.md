...
[![Nuget 1.7.2](https://img.shields.io/nuget/v/AsepriteDotNet?color=blue&style=flat-square)](https://www.nuget.org/packages/AsepriteDotNet/1.7.2)
...
Install via NuGet
```
dotnet add package AsepriteDotNet --version 1.7.2
```
