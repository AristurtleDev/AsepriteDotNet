...
public static class PngWriter
{
    ...
    private static void WriteIHDR(BinaryWriter writer, int width, int height)
    {
        Span<byte> ihdr = stackalloc byte[13];
        ihdr.Clear();
        BinaryPrimitives.WriteInt32BigEndian(ihdr.Slice(0), width);
    ...
    //  IEND
    //
    //  The IEND chunk marks the end of the PNG data stream.
