...
/// </summary>
public sealed class AsepriteTilemapCel<T> : AsepriteCel<T> where T : IColor, new()
{
    ...
    internal AsepriteTilemapCel(AsepriteCelProperties celProperties, AsepriteLayer<T> layer, AsepriteTilemapCelProperties tilemapCelProperties, AsepriteTile[] tiles)
